...
class ResultatController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_resultat_show', array('id' => $resultat->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_resultat_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_resultat_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Resultat $resultat)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_eleve_show', array('id' => $resultat->getEleve()->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_resultat_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Resultat $resultat)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_resultat_delete', array('id' => $resultat->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
